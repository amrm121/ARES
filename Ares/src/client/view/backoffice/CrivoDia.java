 ...
 */
public class CrivoDia extends javax.swing.JFrame {
   DataBaseAcess dba;
   private List<Venda> vendas = new ArrayList<>();
    public CrivoDia() {
       ...
       try {
           ...
           Logger.getLogger(CrivoDia.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrivoDia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
