...
public class GraficoVendaRegiao extends ApplicationFrame{
	...
	private static final long serialVersionUID = 1L;
        ...
        public GraficoVendaRegiao( String applicationTitle , String chartTitle ) {
        ...
        private CategoryDataset createDataset(){
            try {
                ...
                Logger.getLogger(GraficoVendaRegiao.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        GraficoVendaRegiao chart = new GraficoVendaRegiao("Car Usage Statistics", 
