...
public class Vendas extends javax.swing.JFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel57.setText("Telefone do Contato:");
        ...
        statusvenda.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "RASCUNHO", "CONSOLIDADA", "DUPLICADA" }));
                ...
                .addGroup(tDadosC1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, tDadosC1Layout.createSequentialGroup()
                        .addGroup(tDadosC1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(tDadosC1Layout.createSequentialGroup()
                                .addGroup(tDadosC1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, tDadosC1Layout.createSequentialGroup()
                        ...
                        .addGroup(tDadosC1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(datanas, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(tDadosC1Layout.createSequentialGroup()
        ...
        planoV.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel9.setText("Vencimento:");

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel10.setText("Tipo da Conta:");
        ...
        jLabel16.setText("Print da Duração da Chamada:");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tVendas, javax.swing.GroupLayout.DEFAULT_SIZE, 575, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButton1)
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(pEnd3.isEnabled()){
            //end entrega diferente

        }else{
            String idOP = opField.getText();
            int statusV = statusvenda.getSelectedIndex();
            String cNome = cliente.getText();
            String cpf  = cpftit.getText();
            String nasci = datanas.getText();
            String telC = tel.getText();
            String mae = maenome.getText();
            String cepC = cep.getText();
            String endC = end.getText();
            String numC = num.getText();
            String compC = comp.getText();
            String bairroC = bairro.getText();
            String cidC = cidade.getText();
            String estC = estado.getText();
            String pref1C = pref1.getText();
            String pau1C = pau1.getText();
            String ptel1C = ptel1.getText();
            String pref2C = pref2.getText();
            String pau2C = pau2.getText();
            String ptel2C = ptel2.getText();
           // String data = ZonedDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE);
            //ano-mes-dia
            //contadigital -> fatura por email
            String qryVenda = "INSERT INTO vendas (`idvendas`, `idusuario`, `data_venda`, `regiao`, `idplano`, `cliente`, `cpf`, `contato`, `datanasc`,"
            + " `nome_mae`, `cep_endereco`, `endereco`, `numero`, `bairro`, `cidade`, `estado`, `complemento`, `ponto_ref1`, `ponto_ref2`,"
            + " `pessoa_autorizada1`, `pessoa_autorizada2`, `telefonepessoaautorizada1`, `telefonepessoaautorizada2`, `idtipo_conta`, `email`,"
            + " `portabilidade`, `portabilidade_ddd`, `data_vencimento`, `idcampanha`, `idstatus_crivo`, `status_venda`, `contadigital`, `protocolo`)"
            + " VALUES ('9', '1', '2018-06-26', '18', '2', 'TESTE', '11244535465', '8199999-9999', '1926-55-11', 'TESTEMAE', '55555555',"
            + " 'RUA TESTE', '55', 'AFLITOS', 'RECIFE', '15', 'COMPLE', 'REF', 'REF2', 'PESSOAUT1', 'PESSOAAUT2', '81999999999', "
            + "'81555555556', '1', 'email@teste.com', '564654497', '88', 'Dia 10', '1', '1', 'CONSOLIDADA', '1', '21324654465')";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vendas(ramal).setVisible(true);
            }
        });
    }
